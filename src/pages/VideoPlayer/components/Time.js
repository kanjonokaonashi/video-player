export const Time = (props) => {
    ...
    function setTotalTime(totalDuration) {
    ...
    function updateTimeElapsed(currentTime) {
    ...
    return (
        <div className="time">
            <time id="time-elapsed">{updateTimeElapsed(currentTime)}</time>
            <span> / </span>
            <time id="duration">{setTotalTime(totalDuration)}</time>
        </div>
    )
}